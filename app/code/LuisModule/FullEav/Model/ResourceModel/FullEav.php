...
namespace LuisModule\FullEav\Model\ResourceModel;
...
class FullEav extends AbstractEntity
{
    ...
    public function __construct(
        ...
        $this->setType(FullEavSetup::ENTITY_TYPE_CODE);

        $this->setConnection(FullEavSetup::ENTITY_TYPE_CODE . '_read', FullEavSetup::ENTITY_TYPE_CODE . '_write');
