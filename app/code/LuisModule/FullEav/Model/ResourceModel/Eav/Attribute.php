...
namespace LuisModule\FullEav\Model\ResourceModel\Eav;
...
{
    const MODULE_NAME = 'LuisModule_FullEav';
    const KEY_IS_GLOBAL = 'is_global';
    const KEY_IS_STATIC = 'static';
    protected $_eventObject = 'attribute';
    protected static $_labels = null;
    protected $_eventPrefix = FullEavSetup::ENTITY_TYPE_CODE . '_attribute';

    protected function _construct()
    {
        $this->_init(\LuisModule\FullEav\Model\ResourceModel\Attribute::class);
    }
