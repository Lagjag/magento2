...
use LuisModule\FullEav\Setup\EavTablesSetupFactory;
use LuisModule\FullEav\Setup\FullEavSetup;
...
class InstallSchema implements InstallSchemaInterface
{
    ...
    {
        $setup->startSetup();
        $tableName = FullEavSetup::ENTITY_TYPE_CODE;
        ...
        /** @var \LuisModule\FullEav\Setup\EavTablesSetup $eavTablesSetup */
        $eavTablesSetup = $this->eavTablesSetupFactory->create(['setup' => $setup]);
        $eavTablesSetup->createEavTables(FullEavSetup::ENTITY_TYPE_CODE);
        $setup->endSetup();
    }
}